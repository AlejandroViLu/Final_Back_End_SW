...
public class ProductoController {
    ...
    @PostMapping
    public ResponseEntity<MessageDto> insertarProducto(@Valid @RequestBody ProductoDto pro,@Valid @RequestParam("img") MultipartFile file) throws AtributteException, IOException {
